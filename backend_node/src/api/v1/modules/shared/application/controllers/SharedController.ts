...
import { MySQLSharedRepositori } from "../../infraestructure/implementations/MySQL/MySQLSharedRepositori";
...
export class SharedController {
  private readonly sharedRepository: SharedRepository = new MySQLSharedRepositori();
